...
reset:
  ...
  lda #%10010010	;Enables CA1 (ACIA) & CB1 (counter for temperature sensor refresh), disables everything else. Set/Clear Timer1 Timer2 CB1 CB2 ShiftRegister CA1 CA2 
  sta IER3
...
SetupTemperatureTimer:
  ;For 6522-based Timer1 --- too quick to use
  rts
  lda #0
  sta ticks
...
hexOutLookup db "0123456789ABCDEF", 0
 ...
 .org $a000    ; Windows logo graphic -- 4000 in ROM binary file
    win11_0:    .byte "????????????????????????????????????????????????????????????????????????????????????????????????????"
    win11_1:    .byte "????????????????????????????????????????????????????????????????????????????????????????????????????"
    win11_2:    .byte "????????????????????????????????????????????????????????????????????????????????????????????????????"
    win11_3:    .byte "????????????????????????????????????????????????????????????????????????????????????????????????????"
